...
urlpatterns = [
    ...
    path('dashboard/analytics/', views.TeacherDashboardAnalyticsView.as_view(), name='dashboard_analytics'),
    ...
    path('survey/<int:survey_id>/add_question/', views.SurveyQuestionCreateView.as_view(), name='add_question_api'),
    path('survey/<int:survey_id>/add_question/form/', views.AddQuestionView.as_view(), name='add_question_form'),
